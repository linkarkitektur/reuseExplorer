...
namespace linkml{
	...
	class Variable : public Bound, public ProgramElement
	{
	public:
	...
	class LinearExpression : public ProgramElement
	{
	public:
	...
	class LinearConstraint : public LinearExpression, public Bound
	{
	public:
	...
	class LinearObjective : public LinearExpression
	{
	public:

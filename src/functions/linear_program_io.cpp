...
namespace details {
	...
	std::vector<std::pair<int, double>> ordered_coefficients(const linkml::LinearExpression* expr, bool increasing_order /* = true*/) {
...
bool linkml::LinearProgram::save(const std::string& file_name, bool simple_name /* = false*/) const {
...
bool linkml::LinearProgram::load(const std::string& file_name) {

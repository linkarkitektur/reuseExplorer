...
namespace internal {
                ...
                */
                ...
                class Candidate_confidences_custom
                {
                private:
                ...
                template <typename Kernel>
                std::vector<std::size_t> Candidate_confidences_custom<Kernel>::supporting_points(Face_descriptor face, const Polygon_mesh& mesh, const Point_set& point_set) {
                ...
                template <typename Kernel>
                void Candidate_confidences_custom<Kernel>::compute(const Point_set& point_set, Polygon_mesh& mesh) {
                        ...
                        std::vector<Face_descriptor> faces(mesh.faces_begin(), mesh.faces_end());

                        auto bar = util::progress_bar(faces.size(), "Computing confidences");

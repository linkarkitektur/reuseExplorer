...
// This work is based on previouse work by Liangliang Nan. 
//      
...
namespace CGAL {
        ...
        */
        ...
        class Polygonal_surface_reconstruction_custom
        {
        public:
        ...
        public:
                ...
                */
                template <
                        ...
                        typename IndexMap
                >
                        Polygonal_surface_reconstruction_custom(
        ...
        private: // Copying is not allowed
                Polygonal_surface_reconstruction_custom(const Polygonal_surface_reconstruction_custom& psr);

        }; // end of Polygonal_surface_reconstruction_custom
        ...
        template <
                ...
                typename IndexMap
        >
                Polygonal_surface_reconstruction_custom<GeomTraits>::Polygonal_surface_reconstruction_custom(
                        const PointRange& points,
                        PointMap point_map,
                        NormalMap normal_map,
                        IndexMap index_map
        ...
        template <class GeomTraits>
        template <typename PolygonMesh>
        void Polygonal_surface_reconstruction_custom<GeomTraits>::output_candidate_faces(PolygonMesh& candidate_faces) const {
        ...
        template <class GeomTraits>
        template <typename MixedIntegerProgramTraits, typename PolygonMesh>
        bool Polygonal_surface_reconstruction_custom<GeomTraits>::reconstruct(
